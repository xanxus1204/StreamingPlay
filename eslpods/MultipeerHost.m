...
-(void)startClientwithName:(NSString *)name{
   
    
    self.nearbyAd=[[MCNearbyServiceAdvertiser alloc]initWithPeer:self.mPeerID discoveryInfo:nil serviceType:name];
...
-(void)startHostwithName:(NSString *)name{
    if (self.browser==nil) {
